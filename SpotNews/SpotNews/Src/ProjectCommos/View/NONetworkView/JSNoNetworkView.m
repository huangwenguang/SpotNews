...
@implementation JSNoNetworkView
...
+(instancetype)sharedNetworkView {
    static JSNoNetworkView *noNetworkView = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        noNetworkView = [[JSNoNetworkView alloc] init];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    {
        self.netWorkView=[[UIView alloc] initWithFrame:CGRectMake(frame.origin.x,64, frame.size.width,SCREEN_HEIGHT-64)];
