...
@interface JSExampleViewController ()

@end

@implementation JSExampleViewController
...
-(void)tableViewInit
{
  ...
  self.mytableview.mj_header = [MJChiBaoZiHeader headerWithRefreshingTarget:self refreshingAction:@selector(loadNewData1)];
    // 马上进入刷新状态
    [self.mytableview.mj_header beginRefreshing];

   //   self.mytableview.mj_header.automaticallyChangeAlpha = YES;
   self.mytableview.mj_footer = [MJDIYBackFooter footerWithRefreshingTarget:self refreshingAction:@selector(loadNewData)];
